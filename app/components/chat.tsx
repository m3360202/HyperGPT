...
function ChatAction(props: {
  ...
  return (
    ...
    >
      <div ref={iconRef}>{props.icon}</div>
...
export function ChatActions(props: {
  ...
  return (
    <div className={styles["chat-input-actions"]}>
      ...
      {props.isTTSPlaying && props.stopTTS && (
        <ChatAction
          onClick={props.stopTTS}
          text={"停止播报"}
          icon={<StopIcon />}
        />
      )}
                        ...
                        <div className={styles["chat-input-actions"]}>
                          {message.streaming ? (
                            ...
                            <>
                              ...
                              />
                              {process.env.NEXT_PUBLIC_ENABLE_COGTTS &&
                                !isUser && (
                                  <ChatAction
                                    text={
                                      cogTTS.isPlaying &&
                                      cogTTS.playingMessageId === message.id
                                        ? "停止"
                                        : "朗读"
                                    }
                                    icon={
